  ...
  if (!hags.supported) {
    return (
      <div className="flex items-start gap-3 p-3 bg-white/[0.02] border border-white/[0.05] rounded-xl">
        <XCircle size={14} className="text-muted-foreground/55 shrink-0 mt-0.5" />
        <div>
      ...
      <div className="flex items-center justify-between gap-3 p-3 bg-white/[0.02] border border-white/[0.05] rounded-xl">
        <div className="flex items-center gap-2.5">
          {hags.enabled ? (
            ...
            <XCircle size={14} className="text-muted-foreground/55 shrink-0" />
          )}
          <div>
            <p className="text-[12px] font-medium text-white">
              {hags.enabled ? "有効" : "無効"}
              <span className="ml-2 text-[10px] text-muted-foreground/55 font-normal">
    ...
    <div className="space-y-2">
      {displays.map((d, i) => {
        ...
        return (
          ...
          >
            <Monitor size={13} className="text-muted-foreground/55 shrink-0" />
    ...
    <div className="space-y-2.5">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-white/[0.03] border border-white/[0.12] rounded-lg px-3 py-2 text-[11px] font-mono text-slate-200 placeholder:text-muted-foreground/30 outline-none focus:border-cyan-500/40 transition-colors"
        />
        <button
          type="button"
          onClick={handleAdd}
...
export function HagsDisplayOptimizer() {
  ...
  if (loading && !status) {
    return (
      <div className="flex items-center justify-center gap-2 py-8 text-muted-foreground/55">
    ...
    <div className="space-y-5">
      ...
      <div className={sectionCls}>
        <div className={headerCls}>
          ...
          <span className="ml-1 text-[10px] text-muted-foreground/30 bg-white/[0.03] border border-white/[0.05] rounded-full px-2 py-0.5">
