            ...
            {filtered.map((entry) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="mt-1.5 inline-block px-1.5 py-0.5 rounded bg-white/[0.04] border border-white/[0.06] text-[9px] text-muted-foreground/40 uppercase tracking-wide">
